...
$input = "";
$runs = 1
$testText = "Test: ProcessRecord(){}, Input: String.Empty";
...
For($r = 1; $r -le $runs; $r++)
{
   ...
   # "FAIL SMALL"
        ...
        trap [System.Management.Automation.ParameterBindingException]{ "ParameterBindingException"}
        trap [System.Management.Automation.ValidationMetadataException]{ "ValidationMetadataException"}
        trap [Exception]{}
        $end = Get-Date;
...
#Starting Text
out-file -filepath $path -inputobject $testText -Append
